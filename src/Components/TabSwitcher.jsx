...
const TabSwitcher = ({ tabs }) => {
  ...
  return (
    <>
      <div className="flex w-full max-w-md mx-auto border border-gray-700 rounded-md overflow-hidden mb-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold">
        {tabs.map((tab, idx) => (
          <button
            key={tab.label}
